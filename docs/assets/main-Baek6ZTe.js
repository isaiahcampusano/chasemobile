var e={wallet:`<rect x="3" y="6" width="18" height="14" rx="2"/><path d="M3 9h15V5H6a3 3 0 0 0-3 3v1Z"/><path d="M16 13h5v4h-5a2 2 0 0 1 0-4Z"/>`,transfer:`<path d="M7 7h11l-3-3m3 3-3 3"/><path d="M17 17H6l3 3m-3-3 3-3"/><circle cx="12" cy="12" r="9"/><path d="M14.5 9.5c-.5-.8-1.3-1.2-2.5-1.2-1.5 0-2.5.7-2.5 1.8 0 2.8 5.2 1.1 5.2 3.8 0 1.1-1 1.8-2.7 1.8-1.2 0-2.2-.5-2.8-1.4M12 6.8v10.4"/>`,plan:`<path d="M5 3h11l3 3v15H5z"/><path d="M15 3v4h4M8 11h7M8 15h4"/><path d="m13 18 6-6 2 2-6 6-3 1z"/>`,menu:`<path d="M4 7h16M4 12h16M4 17h16"/>`,plus:`<path d="M12 4v16M4 12h16"/>`,search:`<circle cx="11" cy="11" r="6"/><path d="m16 16 4 4"/>`,chat:`<path d="M4 5h13a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3h-5l-4 3v-3H6a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3Z"/><path d="M8 9h7M8 12h5"/>`,user:`<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>`,dots:`<circle cx="5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1" fill="currentColor" stroke="none"/>`,chevron:`<path d="m9 5 7 7-7 7"/>`,card:`<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 9h18M7 14h4"/>`,pig:`<path d="M5 11c.8-3.2 3.6-5 7-5 1.5 0 2.8.3 4 .9l3-1-.6 3.2A6 6 0 0 1 20 13c0 2-1.2 3.7-3 4.7V21h-3v-2H9v2H6v-3.3A7 7 0 0 1 3 12H1v-3h3"/><circle cx="15.5" cy="10.5" r=".8" fill="currentColor" stroke="none"/><path d="M8 6V3h3"/>`,chart:`<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 16v-3M11 16V9M15 16v-5M19 16V7M6 10l4-3 4 2 5-4"/>`,car:`<path d="m5 11 2-5h10l2 5"/><path d="M3 12a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5H3z"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M6 13h2M16 13h2"/>`,cash:`<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="12" cy="12" r="3"/><path d="M6 8h.01M18 16h.01"/>`,bank:`<path d="m3 10 9-6 9 6M5 10h14M6 10v8M10 10v8M14 10v8M18 10v8M4 20h16"/>`,receipt:`<path d="M6 3h12v18l-3-2-3 2-3-2-3 2z"/><path d="M9 8h6M9 12h6M9 16h3"/>`,check:`<rect x="3" y="6" width="16" height="12" rx="2"/><path d="M7 10h5M7 14h3"/><circle cx="18" cy="17" r="3"/><path d="M18 15v4m-2-2h4"/>`,globe:`<circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18"/>`,users:`<circle cx="9" cy="9" r="3"/><path d="M3 20a6 6 0 0 1 12 0M16 7a3 3 0 0 1 0 6M17 14a5 5 0 0 1 4 5"/>`,gear:`<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-2.8 2.8-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.2h-4V21a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1L4.2 17l.1-.1a1.7 1.7 0 0 0 .3-1.9A1.7 1.7 0 0 0 3 14H2.8v-4H3a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9L4.2 7 7 4.2l.1.1A1.7 1.7 0 0 0 9 4.6a1.7 1.7 0 0 0 1-1.6v-.2h4V3a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1L19.8 7l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.2v4H21a1.7 1.7 0 0 0-1.6 1Z"/>`,atm:`<path d="M5 4h14v5H5zM7 9h10v11H7z"/><circle cx="12" cy="14" r="2"/><path d="M12 12v4"/>`,calendar:`<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M7 3v4M17 3v4M3 10h18M7 14h2M11 14h2M15 14h2M7 18h2M11 18h2"/>`,briefcase:`<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V4h8v3M3 12h18M10 12v3h4v-3"/>`,home:`<path d="m3 11 9-8 9 8v10h-6v-7H9v7H3z"/>`,gauge:`<path d="M4 17a8 8 0 1 1 16 0"/><path d="m12 14 4-5M8 17h8"/>`,flower:`<path d="M12 21v-8M12 17c-4 0-6-2-6-5 4 0 6 2 6 5ZM12 15c4 0 6-2 6-5-4 0-6 2-6 5Z"/><circle cx="12" cy="7" r="3"/>`,pie:`<path d="M12 3v9h9A9 9 0 1 1 12 3Z"/><path d="M15 3.5A9 9 0 0 1 20.5 9H15Z"/>`,arrowLeft:`<path d="m15 18-6-6 6-6"/>`,bell:`<path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4"/>`,document:`<path d="M6 3h9l3 3v15H6z"/><path d="M14 3v4h4M9 11h6M9 15h6"/>`,shield:`<path d="M12 3 5 6v5c0 4.5 2.8 8.1 7 10 4.2-1.9 7-5.5 7-10V6z"/><path d="m9 12 2 2 4-4"/>`,logout:`<path d="M10 4H5v16h5M14 8l4 4-4 4M8 12h10"/>`,rotate:`<path d="M4 4v6h6M20 20v-6h-6"/><path d="M5.5 15a8 8 0 0 0 13-6M18.5 9a8 8 0 0 0-13 6"/>`};function t(){return`<svg class="svg-sprite" aria-hidden="true"><defs>${Object.entries(e).map(([e,t])=>`<symbol id="icon-${e}" viewBox="0 0 24 24">${t}</symbol>`).join(``)}</defs></svg>`}function n(e,t=``){return`<svg class="icon ${t}" aria-hidden="true"><use href="#icon-${e}"></use></svg>`}var r=Object.freeze({accounts:[{id:`checking`,name:`Everyday Checking`,lastFour:`4821`,balance:2418.62},{id:`savings`,name:`Personal Savings`,lastFour:`7304`,balance:8760}],transactions:[{id:`txn-1`,merchant:`Oak Street Market`,date:`Jun 24`,amount:-46.28,accountId:`checking`},{id:`txn-2`,merchant:`Northline Energy`,date:`Jun 23`,amount:-62,accountId:`checking`},{id:`txn-3`,merchant:`Direct deposit`,date:`Jun 21`,amount:2100,accountId:`checking`},{id:`txn-4`,merchant:`Metro Internet`,date:`Jun 20`,amount:-74.99,accountId:`checking`},{id:`txn-5`,merchant:`Corner Pharmacy`,date:`Jun 18`,amount:-18.41,accountId:`checking`}],recipients:[{id:`recipient-1`,name:`Avery J.`,lastSent:`2 days ago`},{id:`recipient-2`,name:`Morgan R.`,lastSent:`1 week ago`},{id:`recipient-3`,name:`Family account`,lastSent:`Jun 10`}],bills:[{id:`bill-1`,payee:`Metro Internet`,due:`Jun 28`,amount:74.99},{id:`bill-2`,payee:`Northline Energy`,due:`Jul 2`,amount:112.5}]});function i(){return JSON.parse(JSON.stringify(r))}function a(e){return new Intl.NumberFormat(`en-US`,{style:`currency`,currency:`USD`}).format(e)}var o=[{id:`home`,label:`Home`,icon:`home`},{id:`pay`,label:`Pay & transfer`,icon:`transfer`},{id:`settings`,label:`Settings`,icon:`gear`}];function s(){return`<div class="status-bar status-dark" aria-hidden="true">
    ...
    <div class="simple-title-row">
      ...
      <div class="simple-title-copy">${t?`<span>${t}</span>`:``}<h1>${e}</h1></div>
      <button class="simple-avatar" type="button" data-action="view-profile" aria-label="Open profile">${n(`user`)}</button>
    </div>
  </header>`}function l(e){let t=e.accounts.reduce((e,t)=>e+t.balance,0),r=`${e.bills.length} due by ${e.bills[e.bills.length-1]?.due}`;return`<section class="screen simple-screen simple-home" data-screen="home" aria-label="Accounts">
    ${c(`Accounts`)}
      ...
      <div class="simple-content simple-home-content">
        <section class="simple-overview-card" aria-labelledby="simple-home-balance">
          <div class="simple-balance-hero">
            <h2 id="simple-home-balance">${a(t)}</h2>
  ...
  </section>`}function u(e){return`<section class="screen simple-screen simple-pay" data-screen="pay" aria-label="Pay and transfer">
    ${c(`Pay & transfer`)}
    <div class="screen-scroll" tabindex="0">
      <div class="simple-content">
        <div class="simple-task-stack">
          <button type="button" data-flow="send">${n(`cash`)}<span><strong>Send money</strong></span>${n(`chevron`)}</button>
          <button type="button" data-flow="bill">${n(`receipt`)}<span><strong>Pay a bill</strong></span>${n(`chevron`)}</button>
          <button type="button" data-flow="transfer">${n(`transfer`)}<span><strong>Transfer</strong></span>${n(`chevron`)}</button>
        </div>
      </div>
    </div>
    ...
    <div class="screen-scroll" tabindex="0">
      <div class="simple-content">
        ...
        <div class="simple-settings-list">
          ${d.map(({icon:e,label:t},r)=>`<button type="button" data-settings-section="${r}" aria-label="Open ${t}">${n(e)}<span>${t}</span>${n(`chevron`)}</button>`).join(``)}
          <button class="sign-out-row" type="button" data-action="sign-out" aria-label="Sign out">${n(`logout`)}<span>Sign out</span>${n(`chevron`)}</button>
        </div>
    ...
    <div class="transaction-list">
      ${e.transactions.map(e=>`<button class="transaction-row" type="button" data-transaction-id="${e.id}">
        <span class="transaction-mark">${e.merchant.slice(0,1)}</span>
        <span><strong>${e.merchant}</strong><small>${e.date}</small></span>
        <b class="${e.amount>0?`positive`:``}">${a(e.amount)}</b>
        ${n(`chevron`)}
    ...
    <article class="detail-card">
      ...
      <p>${t?`${t.merchant} for ${a(Math.abs(t.amount))} on ${t.date}`:`No recent charges need review right now.`}</p>
    </article>
    <div class="simple-settings-list detail-action-list">
      <button type="button" data-action="view-all-transactions" aria-label="Review recent activity">${n(`receipt`)}<span>Review recent activity</span>${n(`chevron`)}</button>
    ...
    <div class="settings-profile"><span class="simple-avatar large">${n(`user`)}</span><span><strong>Demo customer</strong><small>Available balance ${a(t)}</small></span></div>
    <div class="simple-controls-card">
      <div><strong>Preferred experience</strong><span>Simple Mode</span></div>
      <div><strong>Trusted helper</strong><span>Connected</span></div>
      <div><strong>Recent activity</strong><span>${e.transactions.length} items</span></div>
    </div>
    <div class="simple-settings-list detail-action-list">
    ...
    <div class="screen-scroll" tabindex="0">
      <div class="plan-content">
        ...
        <section class="stand-section content-section">
          ...
          <article class="credit-card-panel white-panel"><div><h3>See your free credit score</h3><p>Get credit and identity monitoring with Credit Journey&reg;.</p></div><span class="gauge-art colorful">${n(`gauge`)}</span><button class="soft-button demo-action" type="button">Get free score</button></article>
    ...
    <main class="app-shell" data-mode="${e}" data-shell-role="${t}">
      <div class="screens" ${t===`primary`?`aria-live="polite"`:``}></div>
  ...
  </section>`}function I(){return`<aside class="comparison-panel" aria-label="Prototype overview">
  ...
  </aside>`}A.innerHTML=`${t()}<div class="prototype-layout">
  ...
  <section class="prototype-desktop" aria-label="Desktop comparison view">
    <div class="comparison-stage">
      ${F(`current`,`desktop-current`,`Full navigation baseline`)}
      ${F(`simple`,`desktop-simple`,`Simplified concept preview`)}
    </div>
    ${I()}
  </section>
